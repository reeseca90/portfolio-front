...
const About = (props) => {
  ...
  return (
    <div className='aboutPage'>
      ...
      <p>I am a full-stack developer with a long-time passion for learning new things.</p>

      <p>
        Formerly, I was enlisted in the United States Navy. I served as a Nuclear Field Electrician's Mate for 11 years across three duty stations in many roles.&nbsp;
        I started as an operator, maintenance technician, and instructor aboard the MTS-626, a decommissioned nuclear submarine training platform, where I&nbsp;
